...
1. Copy [`SOUL.md`](./SOUL.md) into your agent’s persistent instruction layer.
2. Replace `[AGENT_NAME]` and adapt “the owner” if desired.
3. Keep applicable authority boundaries explicit and consistently available; this compass does not grant permissions.
4. Keep changing state—projects, schedules, credentials, and task history—elsewhere.
